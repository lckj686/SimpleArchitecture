package com.simple.architecture.frame.log;
...
import com.simple.architecture.frame.config.CommonProxy;
...
public class CollectCrashUtil {
    ...
    public String getCrashDirPath() {
        ...
        if (isSdcardExist()) {
            ...
            File file = CommonProxy.getInstance().getApplicationContext().getDir("crash", Context.MODE_PRIVATE);
...
//        String result = writer.toString();
        ...
        try {
            ...
            String logPathDir = getCrashDirPath();
