package com.simple.architecture.frame.log.log4;

import android.os.Environment;
import android.util.Log;

import com.simple.architecture.BuildConfig;
...
public class LoggerUtil {
    private static final String root = "com.chinanetcenter.cloudtv";
    ...
    private static final String LogPath = isSdcardExist() ? (Environment
            ...
            + File.separator + "com_wstv_cloudtv" + File.separator) : null;
    private static final String FileName = "com_wstv_cloudtv.log";
