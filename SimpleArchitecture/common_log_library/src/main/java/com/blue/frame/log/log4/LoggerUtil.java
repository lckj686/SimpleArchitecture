package com.blue.frame.log.log4;
...
public class LoggerUtil {
    private static String root = null;// = "com.chinanetcenter.cloudtv";

    private static String LogPath = null;
    //            = isSdcardExist() ? (Environment
//            .getExternalStorageDirectory()
//            + File.separator + "com_wstv_cloudtv" + File.separator) : null;
    private static String FileName = null;// = "com_wstv_cloudtv.log";
